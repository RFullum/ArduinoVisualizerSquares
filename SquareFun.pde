// Draws squares and changes colors based on arduino amplitude input
public class SquareFun
{
  ...
  float threshHi = 0.5f;  // initial = 0.5f
  float threshLo = 0.2f;  // initial = 0.2f
  int threshCount = 0;    // initial = 0
  int rgbCount = 0;       // initial = 0
